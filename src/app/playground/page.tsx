...
const HeroLogo3D = dynamic<{ isDark: boolean }>(() => import("./HeroLogo3D"), { ssr: false });
...
function CustomCursor() {
    ...
    useEffect(() => {
        const onMouseMove = (e: MouseEvent) => {
            if (dotRef.current) {
                // Pinning the top-left of the rotated box to the mouse click pixel
    ...
    return (
        <div className="pg-cursor-dot" ref={dotRef}>
            {/* By rotating -90deg around the center, the original top-right sharp corner perfectly becomes the top-left click pointer shrink down to w-5 h-5 for precision */}
...
/* ================================================================
   SERVICES REWORK (V2 - Creators vs Brands)
   ================================================================ */
const SERVICES_DATA = {
    creator: {
        theme: "text-[#FF9933]",
...
const PROJECTS = [
    ...
    {
        title: "Ali Abdaal — Productivity Empire",
        tags: ["Video Editing", "Creator"],
        desc: "High-retention long-form YouTube editing and thumbnail direction for a massive productivity channel.",
    ...
    return (
        <section id="work" className="py-32 px-6">
            <div className="max-w-6xl mx-auto space-y-16">
                ...
                {/* Pixelorb-style Asymmetric Bento Portfolio */}
                ...
                <div className="flex justify-center pt-8">
                    <a href="#contact" className="pg-btn pg-btn-primary group">
    ...
    return (
        <section className="pt-16 pb-32 overflow-hidden bg-transparent text-[var(--text)] relative mt-0" id="testimonials">
            ...
            <div className="flex overflow-hidden relative w-full h-full group">
                {/* Edge fade gradients matching standard flow background */}
                <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[#F9F9F8] to-transparent z-10 pointer-events-none" />
                <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[#F9F9F8] to-transparent z-10 pointer-events-none" />
                ...
                <div className="flex gap-8 group-hover:[animation-play-state:paused] py-4" style={{ width: "max-content", animation: "scroll 40s linear infinite" }}>
                    {[...TESTIMONIALS, ...TESTIMONIALS].map((t, i) => (
                        <div key={i} className="w-[400px] md:w-[500px] bg-[var(--surface)] border-2 border-[var(--border)] shadow-[0_4px_0_0_rgba(0,0,0,0.05)] p-10 rounded-[32px] shrink-0 transition-transform duration-300 hover:-translate-y-2 hover:border-[var(--border-hover)]">
                            ...
                            <p className="text-xl md:text-2xl font-serif text-[var(--text)] whitespace-normal mb-10 leading-snug">"{t.text}"</p>
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full flex flex-col md:flex-row items-center justify-between border-t border-white/10 pt-10 pb-4 gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-end text-white/30 text-[10px] md:text-xs md:w-1/3 mt-2 md:mt-0">
                        <span>© 2026 Aova Design Studio.</span>
